...
def Scrap():
    ...
    for i in ttt:
        ...
        total_cases.append(int(id[2].text.strip().replace(',', '')))#only it is converted into int because in this behalf sorting will be donel
...
path = ''
#############################Labels
IntroLabel = Label(root,text='Corona Virus Info',font=('new roman',30,'italic bold'),bg='MediumTurquoise',width=22)
IntroLabel.place(x=0,y=0)
EntryLabel = Label(root,text='Notify Country : ',font=('arial',20,'italic bold'),bg='LightGrey')
EntryLabel.place(x=10,y=70)
FormatLabel = Label(root,text='Download In : ',font=('arial',20,'italic bold'),bg='LightGrey')
FormatLabel.place(x=10,y=150)

countrydata = StringVar()
ent1 = Entry(root,textvariable=countrydata,font=('arial',20,'italic bold'),relief=RIDGE,bd=2,bg='Lavender',width=20)
ent1.place(x=220,y=70)

InHtml = Button(root,text='Html',bg='LightSteelBlue',font=('arial',15,'italic bold'),relief=RIDGE,activebackground='SteelBlue',activeforeground='white',
                bd=5,width=5,command=inhtml)
InHtml.place(x=210,y=150)

InJson = Button(root,text='Json',bg='LightSteelBlue',font=('arial',15,'italic bold'),relief=RIDGE,activebackground='SteelBlue',activeforeground='white',
                bd=5,width=5,command=injson)
InJson.place(x=320,y=150)

InCsv = Button(root,text='Csv',bg='LightSteelBlue',font=('arial',15,'italic bold'),relief=RIDGE,activebackground='SteelBlue',activeforeground='white',
                bd=5,width=5,command=incsv)
InCsv.place(x=430,y=150)

Submit = Button(root,text='Submit',bg='CadetBlue',font=('arial',15,'italic bold'),relief=RIDGE,activebackground='DarkCyan',activeforeground='white',
